let  audio, playbtn , title , poster, artists, mutebtn, seekslider, volumeslider,  seeking=false , seekto, curtimetext , durtimetext , playlist_status , dir, playlist, ext, agent , playlist_artist, repeat , randomSong , nextbtn , prevbtn ;

dir="music/";
playlist = ["Cartoon","Elektronomia","Johnning","Popsicle","Fearless"];
title=["Cartoon - On & On","Elektronomia","Janji-Heroes Tonight", "Popsicle" , "Lost Sky Fearless"];
artists = ["(feat. Daniel Levi) [NCS Release]","Elektromania Sky High [NCS Relase]","(.feat Johnning)[NCS Release]","LFZ-[NCS Release]","(.feat Chris Linton)[NCS Release]"];
